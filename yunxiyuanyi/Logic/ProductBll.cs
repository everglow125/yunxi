...
namespace Logic
{
    public class ProductBll : IProductBll
    {
        ...
        private IProductDal Instance;
        public ProductBll(IProductDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        /// 是否已存在
        /// </summary>
        public bool IsExisted(Product t)
        {
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Product> GetList(Product t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Product> GetList(Product t, out int recordCount)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Product> ts)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Product> ts)
        {
