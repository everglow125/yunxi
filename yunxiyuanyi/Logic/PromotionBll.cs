...
namespace Logic
{
    public class PromotionBll : IPromotionBll
    {
        ...
        private IPromotionDal Instance;
        public PromotionBll(IPromotionDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        /// 是否已存在
        /// </summary>
        public bool IsExisted(Promotion t)
        {
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Promotion> GetList(Promotion t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Promotion> GetList(Promotion t, out int recordCount)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Promotion> ts)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Promotion> ts)
        {
