...
namespace Logic
{
    public class MessageBll : IMessageBll
    {
        ...
        private IMessageDal Instance;
        public MessageBll(IMessageDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        /// 是否已存在
        /// </summary>
        public bool IsExisted(Message t)
        {
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Message> GetList(Message t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Message> GetList(Message t, out int recordCount)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Message> ts)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Message> ts)
        {
