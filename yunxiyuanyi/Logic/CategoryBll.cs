...
namespace Logic
{
    public class CategoryBll : ICategoryBll
    {
        ...
        private ICategoryDal Instance;
        public CategoryBll(ICategoryDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        /// 是否已存在
        /// </summary>
        public bool IsExisted(Category t)
        {
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Category> GetList(Category t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Category> GetList(Category t, out int recordCount)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Category> ts)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Category> ts)
        {
