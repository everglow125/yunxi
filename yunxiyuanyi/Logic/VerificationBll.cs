...
namespace Logic
{
    public class VerificationBll : IVerificationBll
    {
        ...
        private IVerificationDal Instance;
        public VerificationBll(IVerificationDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        /// 是否已存在
        /// </summary>
        public bool IsExisted(Verification t)
        {
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Verification> GetList(Verification t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Verification> GetList(Verification t, out int recordCount)
        {
        ...
        /// 新增对象
        /// </summary>
        public int Insert(Verification t)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Verification> ts)
        {
        ...
        /// 更新对象
        /// </summary>
        public int Update(Verification t)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Verification> ts)
        {
