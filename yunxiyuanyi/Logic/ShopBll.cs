...
namespace Logic
{
    public class ShopBll : IShopBll
    {
        ...
        private IShopDal Instance;
        public ShopBll(IShopDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Shop> GetList(Shop t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Shop> GetList(Shop t, out int recordCount)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Shop> ts)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Shop> ts)
        {
