...
namespace Logic
{
    public class OrderBll : IOrderBll
    {
        ...
        private IOrderDal Instance;
        public OrderBll(IOrderDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Order> GetList(Order t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Order> GetList(Order t, out int recordCount)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Order> ts)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Order> ts)
        {
