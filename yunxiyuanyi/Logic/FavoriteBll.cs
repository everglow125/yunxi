...
namespace Logic
{
    public class FavoriteBll : IFavoriteBll
    {

        private IFavoriteDal Instance;
        public FavoriteBll(IFavoriteDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        /// 是否已存在
        /// </summary>
        public bool IsExisted(Favorite t)
        {
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Favorite> GetList(Favorite t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Favorite> GetList(Favorite t, out int recordCount)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Favorite> ts)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Favorite> ts)
        {
