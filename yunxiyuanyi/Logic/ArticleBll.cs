...
namespace Logic
{
    public class ArticleBll : IArticleBll
    {
        ...
        private IArticleDal Instance;
        public ArticleBll(IArticleDal instance)
        {
            Instance = instance;
        }
        /// <summary>
        /// 是否已存在
        /// </summary>
        public bool IsExisted(Article t)
        {
        ...
        /// 根据条件返回所有信息
        /// </summary>
        public IList<Article> GetList(Article t)
        {
        ...
        /// 根据条件返回指定页的数据
        /// </summary>
        public IList<Article> GetList(Article t, out int recordCount)
        {
        ...
        /// 批量新增对象
        /// </summary>
        public int BatchInsert(IList<Article> ts)
        {
        ...
        /// 批量更新对象
        /// </summary>
        public int BatchUpdate(IList<Article> ts)
        {
